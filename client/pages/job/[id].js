   ...
   const fetchJob = async () => {
      try {
         const { data } = await axios.get(
            `http://localhost:5000/api/job/${_id}`,
            {
               headers: {
      ...
      <div>
         <div>
            ...
            <section class="bg-gray-100 py-20">
               <div class="max-w-5xl mx-auto py-0 md:py-13">
                              ...
                              <div class="flex justify-between items-top">
                                 <div class="space-y-4">
                                    <div>
                                       <img
                                          class="
                                       h-12 object-cover mb-4
                                       hidden object-cover w-12  mx-3 rounded-full sm:block
                                       "
                                          src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse2.mm.bing.net%2Fth%3Fid%3DOIP.m4maRkVK7z9vEDTHIcSZ0QHaEK%26pid%3DApi&f=1"
                                       />
