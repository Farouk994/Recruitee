...
const register = () => {
   ...
   return (
      <div>
         {/* <!-- component --> */}
         <section class="h-screen bg-gradient-to-br from-blue-600 to-indigo-600 flex justify-center items-center w-full">
            <img
               ...
               <div class="max-w-5xl mx-auto">
                  <div class="flex flex-wrap items-center -mx-4">
                     ...
                     <div class="w-full lg:w-1/2 px-4">
                        <div class="px-6 lg:px-20 py-12 lg:py-24 dark:bg-gray-800 rounded-lg">
                           <form action="#">
                              ...
                              <button class="py-4 w-full bg-pink-500 hover:bg-blue-600 text-white font-bold rounded-full transition duration-200">
                                 Get started
                              </button>
                           </form>
                        </div>
